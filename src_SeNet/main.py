...
from DataLoader import DatasetFolder
...
def get_loaders():
    ...
    a = set(trainset.train_data).intersection(testset.test_data)
...
optimizer = optim.SGD([{'params': resnet_model.parameters(), 'lr': args.lr}],
                           lr=args.lr,
                           momentum=0.9,
                           nesterov=True,
                           weight_decay=0.0005)
